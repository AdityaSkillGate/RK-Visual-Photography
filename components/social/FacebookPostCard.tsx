          ...
          >
            ...
            <div className="flex items-center justify-between pt-2 border-t border-bronze-border/30">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 rounded-full bg-gold-500 px-4 py-1.5 text-xs font-semibold uppercase tracking-editorial text-charcoal-950 hover:bg-gold-400 transition-colors shadow-gold-subtle whitespace-nowrap shrink-0"
              >
